/*** Database Objects ***/
/*** Object: Database [DDS] Scripte Date: 02/05/2026 ***/

/***
Project			: Amadeus Entertainment Data Warehouse
Object			: DDS (Dimensional Data Store)
Author			: Nkosinathi Mlotshwa
Date			: 02/05/2026
Description		: Creates the DDS database across six filegroups
	              simulating six physical data disks.
	              Scaled down for development environment (MB not GB)
***/
